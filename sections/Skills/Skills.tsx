...
const Skills: React.FC = () => {
  ...
  const skills = {
    languages: [
      ...
      { name: 'SQL', icon: 'database', level: 'intermediate', category: 'Language' },
    ],
    frameworks: [
    ...
    databases: [
      ...
      { name: 'PostgreSQL', icon: 'postgresql', level: 'intermediate', category: 'Database' },
      { name: 'Redis', icon: 'redis', level: 'beginner', category: 'Database' },
    ],
    'ai-ml': [
      { name: 'TensorFlow', icon: 'tensorflow', level: 'intermediate', category: 'AI/ML' },
      { name: 'Scikit-learn', icon: 'scikit', level: 'advanced', category: 'AI/ML' },
      { name: 'PyTorch', icon: 'pytorch', level: 'intermediate', category: 'AI/ML' },
      { name: 'OpenCV', icon: 'opencv', level: 'intermediate', category: 'AI/ML' },
      { name: 'Pandas', icon: 'pandas', level: 'advanced', category: 'AI/ML' },
      { name: 'NumPy', icon: 'numpy', level: 'advanced', category: 'AI/ML' },
    ],
    tools: [
      { name: 'Git', icon: 'git', level: 'advanced', category: 'Tool' },
      { name: 'Docker', icon: 'docker', level: 'intermediate', category: 'Tool' },
      { name: 'AWS', icon: 'aws', level: 'beginner', category: 'Tool' },
      { name: 'Vercel', icon: 'vercel', level: 'advanced', category: 'Tool' },
